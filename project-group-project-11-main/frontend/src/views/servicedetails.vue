    ...
    async submitServiceUpdate() {
      ...
      try {
        ...
        const ok = await this.$refs.confirmDialogue.show({
          confirmationTitle: 'Update Service',
          confirmationMessage: 'Are you sure you want to update this service? It cannot be undone.',
          confirmationButton: 'Update Service',
        })
        // If you throw an error, the method will terminate here unless you surround it wil try/catch
        if (ok) {
          alert('You have successfully updated this service.')
    ...
    async submitDeleteService() {
      try {
        ...
        const ok = await this.$refs.confirmDialogue.show({
          ...
          confirmationMessage: 'Are you sure you want to delete this service? It cannot be undone.',
          confirmationButton: 'Delete Service',
        })
        // If you throw an error, the method will terminate here unless you surround it wil try/catch
        if (ok) {
          alert('You have successfully delete this service.')
